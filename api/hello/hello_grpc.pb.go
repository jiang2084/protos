...
const (
	Greeter_Hello_FullMethodName = "/hello.Greeter/Hello"
	Greeter_Ping_FullMethodName  = "/hello.Greeter/Ping"
)
...
type GreeterClient interface {
	Hello(ctx context.Context, in *HelloReply, opts ...grpc.CallOption) (*HelloReply, error)
...
func (c *greeterClient) Hello(ctx context.Context, in *HelloReply, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (c *greeterClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingReply, error) {
	out := new(PingReply)
...
func (UnimplementedGreeterServer) Hello(context.Context, *HelloReply) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Hello not implemented")
}
func (UnimplementedGreeterServer) Ping(context.Context, *PingRequest) (*PingReply, error) {
...
func _Greeter_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Hello(ctx, req.(*HelloReply))
	}
